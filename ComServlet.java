...
/**
 * 
 * Handling business, adding express information, etc. are all done here
 * 
 * @author Ray
 *
 */
public class ComServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(method.equals("addTH")){  //add increase
		...
		else if(method.equals("upTH")){ ///update Update
...
//				request.getRequestDispatcher("member/prep/index.jsp").forward(request, response); 
				...
				request.setAttribute("message", "operation failed£¡,cannot modify the delivery information after confirmation");
				request.getRequestDispatcher("./ExpressageManager").forward(request, response); 
				return ;
			}
		}
